...
7. Back in Cognito, select **App client settings** under the connected-vehicle-user-pool.
 ...
 - Put the CloudFront domain name in the **Callback URL(s)** and **Sign out URL(s)** dialog box.
...
Browse to the CloudFront domain name created earlier and use the Cognito User you created earlier on to log-in.
